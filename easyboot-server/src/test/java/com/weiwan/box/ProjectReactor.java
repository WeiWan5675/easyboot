...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.weiwan.box";
    private static final String ARTIFACT_ID = "easyboot";
    private static final String PACKAGE_NAME = "com.weiwan.box";
    private static final String TITLE = "Easy Boot";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.weiwan.box";
        String artifactIdNew = "easyboot";
        String packageNameNew = "com.weiwan.box";
        String titleNew = "Easy Boot";
