package com.weiwan.box.module.trade.controller.admin.config;
...
import com.weiwan.box.module.trade.convert.config.TradeConfigConvert;
...
public class TradeConfigController {
    ...
    @Value("${easyboot.tencent-lbs-key}")
