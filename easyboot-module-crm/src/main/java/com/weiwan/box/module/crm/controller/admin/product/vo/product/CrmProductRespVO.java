package com.weiwan.box.module.crm.controller.admin.product.vo.product;
...
public class CrmProductRespVO implements VO {
    ...
    @Trans(type = TransType.SIMPLE, targetClassName = "com.weiwan.box.module.system.dal.dataobject.user.AdminUserDO",
