package com.weiwan.box.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.weiwan.box.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
