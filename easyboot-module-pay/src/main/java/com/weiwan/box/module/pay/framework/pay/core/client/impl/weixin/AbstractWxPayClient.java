package com.weiwan.box.module.pay.framework.pay.core.client.impl.weixin;
...
import com.weiwan.box.framework.common.util.io.FileUtils;
...
import static com.weiwan.box.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V2;
import static com.weiwan.box.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V3;
...
public abstract class AbstractWxPayClient extends AbstractPayClient<WxPayClientConfig> {
    ...
    private SignatureHeader getRequestHeader(Map<String, String> headers) {
        // 参见 https://gitee.com/zhijiantianya/easyboot-cloud/issues/ICSFL6
