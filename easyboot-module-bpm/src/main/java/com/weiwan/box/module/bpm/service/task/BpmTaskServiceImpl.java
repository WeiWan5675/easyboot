package com.weiwan.box.module.bpm.service.task;
...
import com.weiwan.box.framework.common.util.date.DateUtils;
import com.weiwan.box.framework.common.util.number.NumberUtils;
import com.weiwan.box.framework.common.util.object.ObjectUtils;
import com.weiwan.box.framework.common.util.object.PageUtils;
import com.weiwan.box.framework.datapermission.core.annotation.DataPermission;
import com.weiwan.box.framework.web.core.util.WebFrameworkUtils;
import com.weiwan.box.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import com.weiwan.box.module.bpm.controller.admin.task.vo.task.*;
import com.weiwan.box.module.bpm.convert.task.BpmTaskConvert;
import com.weiwan.box.module.bpm.dal.dataobject.definition.BpmFormDO;
import com.weiwan.box.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.weiwan.box.module.bpm.enums.definition.*;
import com.weiwan.box.module.bpm.enums.task.BpmCommentTypeEnum;
import com.weiwan.box.module.bpm.enums.task.BpmReasonEnum;
import com.weiwan.box.module.bpm.enums.task.BpmTaskSignTypeEnum;
import com.weiwan.box.module.bpm.enums.task.BpmTaskStatusEnum;
import com.weiwan.box.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import com.weiwan.box.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.weiwan.box.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import com.weiwan.box.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import com.weiwan.box.module.bpm.framework.flowable.core.util.FlowableUtils;
import com.weiwan.box.module.bpm.service.definition.BpmFormService;
import com.weiwan.box.module.bpm.service.definition.BpmModelService;
import com.weiwan.box.module.bpm.service.definition.BpmProcessDefinitionService;
import com.weiwan.box.module.bpm.service.message.BpmMessageService;
import com.weiwan.box.module.bpm.service.message.dto.BpmMessageSendWhenTaskTimeoutReqDTO;
import com.weiwan.box.module.system.api.dept.DeptApi;
import com.weiwan.box.module.system.api.dept.dto.DeptRespDTO;
...
import static com.weiwan.box.module.bpm.enums.ErrorCodeConstants.*;
import static com.weiwan.box.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static com.weiwan.box.module.bpm.framework.flowable.core.enums.BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_RETURN_FLAG;
import static com.weiwan.box.module.bpm.framework.flowable.core.enums.BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_SKIP_START_USER_NODE;
import static com.weiwan.box.module.bpm.framework.flowable.core.util.BpmnModelUtils.*;
...
//        }
    ...
    public void rejectTask(Long userId, @Valid BpmTaskRejectReqVO reqVO) {
        ...
        // 疑问：为什么要标记未通过呢？
        // 回答：例如说 A 任务被向前加签除 B 任务时，B 任务被审批不通过，此时 A 会被取消。而 easyboot-ui-admin-vue3 不展示“已取消”的任务，导致展示不出审批不通过的细节。
    ...
    public void delegateTask(Long userId, BpmTaskDelegateReqVO reqVO) {
        ...
        // 特殊：如果已经被委派（owner 非空），则不需要更新 owner：https://gitee.com/zhijiantianya/easyboot-cloud/issues/ICJ153
    ...
    public void transferTask(Long userId, BpmTaskTransferReqVO reqVO) {
        ...
        // 3.1 设置任务所有人 (owner) 为原任务的处理人 (assignee)
        // 特殊：如果已经被转派（owner 非空），则不需要更新 owner：https://gitee.com/zhijiantianya/easyboot-cloud/issues/ICJ153
        if (StrUtil.isEmpty(task.getOwner())) {
            taskService.setOwner(taskId, task.getAssignee());
        }
    ...
    public void processTaskCreated(Task task) {
        ...
        TransactionSynchronizationManager.registerSynchronization(new TransactionSynchronization() {
             ...
             * 参见 <a href="https://gitee.com/zhijiantianya/easyboot-cloud/issues/IB7V7Q">issue</a> 反馈
             */
            @Override
