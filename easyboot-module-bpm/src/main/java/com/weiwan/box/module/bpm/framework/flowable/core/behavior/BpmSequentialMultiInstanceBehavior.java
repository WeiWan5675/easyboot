package com.weiwan.box.module.bpm.framework.flowable.core.behavior;

import cn.hutool.core.collection.CollUtil;
import com.weiwan.box.framework.common.util.collection.SetUtils;
import com.weiwan.box.module.bpm.enums.definition.BpmChildProcessMultiInstanceSourceTypeEnum;
...
public class BpmSequentialMultiInstanceBehavior extends SequentialMultiInstanceBehavior {
    ...
    protected void executeOriginalBehavior(DelegateExecution execution, ExecutionEntity multiInstanceRootExecution, int loopCounter) {
        ...
        // 参见 https://gitee.com/zhijiantianya/easyboot-cloud/issues/IC239F
