package com.weiwan.box.module.ai.framework.ai.core;
...
import com.weiwan.box.framework.common.util.spring.SpringUtils;
import com.weiwan.box.module.ai.enums.model.AiPlatformEnum;
import com.weiwan.box.module.ai.framework.ai.config.AiAutoConfiguration;
import com.weiwan.box.module.ai.framework.ai.config.EasybootAiProperties;
...
import com.weiwan.box.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import com.weiwan.box.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            EasybootAiProperties.MidjourneyProperties properties = SpringUtil.getBean(EasybootAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(EasybootAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        EasybootAiProperties.DouBaoProperties properties = new EasybootAiProperties.DouBaoProperties()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(EasybootAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        EasybootAiProperties.HunYuanProperties properties = new EasybootAiProperties.HunYuanProperties()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(EasybootAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        EasybootAiProperties.SiliconFlowProperties properties = new EasybootAiProperties.SiliconFlowProperties()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(EasybootAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        EasybootAiProperties.XingHuoProperties properties = new EasybootAiProperties.XingHuoProperties()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(EasybootAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        EasybootAiProperties.BaiChuanProperties properties = new EasybootAiProperties.BaiChuanProperties()
                .setApiKey(apiKey);
