package com.weiwan.box.framework.desensitize.core;

import com.weiwan.box.framework.common.util.json.JsonUtils;
import com.weiwan.box.framework.desensitize.core.annotation.Address;
import com.weiwan.box.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.weiwan.box.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.weiwan.box.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
