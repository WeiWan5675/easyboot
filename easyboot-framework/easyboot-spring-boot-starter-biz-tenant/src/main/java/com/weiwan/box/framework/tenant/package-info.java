 ...
 *      1）Spring Async：
 *          {@link com.weiwan.box.framework.quartz.config.EasybootAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 EasybootSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.weiwan.box.framework.tenant;
