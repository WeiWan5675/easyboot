package com.weiwan.box.framework.ratelimiter.config;

import com.weiwan.box.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.weiwan.box.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.weiwan.box.framework.ratelimiter.core.keyresolver.impl.*;
...
public class EasybootRateLimiterConfiguration {
