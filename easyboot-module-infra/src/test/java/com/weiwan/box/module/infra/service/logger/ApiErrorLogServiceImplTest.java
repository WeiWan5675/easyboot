package com.weiwan.box.module.infra.service.logger;
...
import com.weiwan.box.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.weiwan.box.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.weiwan.box.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.weiwan.box.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.weiwan.box.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.weiwan.box.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("easyboot-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("easyboot-test");
