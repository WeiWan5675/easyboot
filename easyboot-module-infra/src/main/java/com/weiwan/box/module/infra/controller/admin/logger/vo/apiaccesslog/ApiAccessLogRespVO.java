package com.weiwan.box.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(com.weiwan.box.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
