package com.weiwan.box.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.weiwan.box.framework.common.enums.CommonStatusEnum;
import com.weiwan.box.framework.common.exception.ServiceException;
import com.weiwan.box.framework.common.pojo.PageResult;
import com.weiwan.box.framework.common.util.collection.ArrayUtils;
import com.weiwan.box.framework.common.util.collection.CollectionUtils;
import com.weiwan.box.framework.test.core.ut.BaseDbUnitTest;
import com.weiwan.box.module.infra.api.config.ConfigApi;
import com.weiwan.box.module.infra.api.file.FileApi;
import com.weiwan.box.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.weiwan.box.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.weiwan.box.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.weiwan.box.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.weiwan.box.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.weiwan.box.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import com.weiwan.box.module.system.dal.dataobject.dept.DeptDO;
import com.weiwan.box.module.system.dal.dataobject.dept.PostDO;
import com.weiwan.box.module.system.dal.dataobject.dept.UserPostDO;
import com.weiwan.box.module.system.dal.dataobject.tenant.TenantDO;
import com.weiwan.box.module.system.dal.dataobject.user.AdminUserDO;
import com.weiwan.box.module.system.dal.mysql.dept.UserPostMapper;
import com.weiwan.box.module.system.dal.mysql.user.AdminUserMapper;
import com.weiwan.box.module.system.enums.common.SexEnum;
import com.weiwan.box.module.system.service.dept.DeptService;
import com.weiwan.box.module.system.service.dept.PostService;
import com.weiwan.box.module.system.service.permission.PermissionService;
import com.weiwan.box.module.system.service.tenant.TenantService;
...
import static com.weiwan.box.framework.common.util.collection.SetUtils.asSet;
import static com.weiwan.box.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.weiwan.box.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.weiwan.box.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.weiwan.box.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.weiwan.box.framework.test.core.util.AssertUtils.assertServiceException;
import static com.weiwan.box.framework.test.core.util.RandomUtils.*;
import static com.weiwan.box.module.system.enums.ErrorCodeConstants.*;
import static com.weiwan.box.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("easybootyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("easybootyuanma");
        ...
        assertEquals("easybootyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("easybootyuanma"))).thenReturn("java");
