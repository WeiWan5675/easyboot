package com.weiwan.box.module.system.service.social;
...
import com.weiwan.box.framework.common.util.cache.CacheUtils;
import com.weiwan.box.framework.common.util.http.HttpUtils;
import com.weiwan.box.framework.common.util.object.BeanUtils;
import com.weiwan.box.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.weiwan.box.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.weiwan.box.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.weiwan.box.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.weiwan.box.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.weiwan.box.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.weiwan.box.module.system.dal.dataobject.social.SocialClientDO;
import com.weiwan.box.module.system.dal.mysql.social.SocialClientMapper;
import com.weiwan.box.module.system.dal.redis.RedisKeyConstants;
import com.weiwan.box.module.system.enums.social.SocialTypeEnum;
import com.weiwan.box.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.weiwan.box.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.weiwan.box.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${easyboot.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${easyboot.wxa-subscribe-message.miniprogram-state:formal}")
