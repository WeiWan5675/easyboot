package com.weiwan.box.module.mp.service.account;
...
import com.weiwan.box.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import com.weiwan.box.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import com.weiwan.box.module.mp.convert.account.MpAccountConvert;
import com.weiwan.box.module.mp.dal.dataobject.account.MpAccountDO;
import com.weiwan.box.module.mp.dal.mysql.account.MpAccountMapper;
import com.weiwan.box.module.mp.enums.ErrorCodeConstants;
...
import static com.weiwan.box.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 easyboot-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
