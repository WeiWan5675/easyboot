package com.weiwan.box.module.mp.service.message;
...
import com.weiwan.box.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import com.weiwan.box.module.mp.convert.message.MpMessageConvert;
...
import com.weiwan.box.module.mp.dal.dataobject.user.MpUserDO;
import com.weiwan.box.module.mp.dal.mysql.message.MpMessageMapper;
import com.weiwan.box.module.mp.enums.message.MpMessageSendFromEnum;
import com.weiwan.box.module.mp.framework.mp.core.MpServiceFactory;
import com.weiwan.box.module.mp.framework.mp.core.util.MpUtils;
import com.weiwan.box.module.mp.service.account.MpAccountService;
import com.weiwan.box.module.mp.service.material.MpMaterialService;
import com.weiwan.box.module.mp.service.message.bo.MpMessageSendOutReqBO;
import com.weiwan.box.module.mp.service.user.MpUserService;
...
import static com.weiwan.box.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
