package com.weiwan.box.module.iot.plugin.emqx.config;
...
import com.weiwan.box.module.iot.plugin.emqx.downstream.IotDeviceDownstreamHandlerImpl;
import com.weiwan.box.module.iot.plugin.emqx.upstream.IotDeviceUpstreamServer;
...
public class IotPluginEmqxAutoConfiguration {
    ...
    public MqttClient mqttClient(Vertx vertx, IotPluginEmqxProperties emqxProperties) {
        MqttClientOptions options = new MqttClientOptions()
                .setClientId("easyboot-iot-downstream-" + IdUtil.fastSimpleUUID())
