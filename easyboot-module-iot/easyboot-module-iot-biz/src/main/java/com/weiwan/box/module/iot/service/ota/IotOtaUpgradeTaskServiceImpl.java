package com.weiwan.box.module.iot.service.ota;
...
import com.weiwan.box.module.iot.controller.admin.ota.vo.upgrade.task.IotOtaUpgradeTaskPageReqVO;
import com.weiwan.box.module.iot.controller.admin.ota.vo.upgrade.task.IotOtaUpgradeTaskSaveReqVO;
...
import com.weiwan.box.module.iot.dal.dataobject.ota.IotOtaUpgradeTaskDO;
import com.weiwan.box.module.iot.dal.mysql.ota.IotOtaUpgradeTaskMapper;
import com.weiwan.box.module.iot.enums.ota.IotOtaUpgradeTaskScopeEnum;
import com.weiwan.box.module.iot.enums.ota.IotOtaUpgradeTaskStatusEnum;
...
public class IotOtaUpgradeTaskServiceImpl implements IotOtaUpgradeTaskService {
     ...
     * @throws com.weiwan.box.framework.common.exception.ServerException 则抛出预定义的异常
     */
     ...
     * @throws com.weiwan.box.framework.common.exception.ServiceException，抛出相应的异常
     */
     ...
     * @throws com.weiwan.box.framework.common.exception.ServiceException 如果升级任务不存在，则抛出异常提示任务不存在
     */
