...
import com.weiwan.box.module.iot.controller.admin.ota.vo.upgrade.record.IotOtaUpgradeRecordPageReqVO;
...
import com.weiwan.box.module.iot.dal.dataobject.ota.IotOtaUpgradeRecordDO;
import com.weiwan.box.module.iot.dal.dataobject.ota.IotOtaUpgradeTaskDO;
import com.weiwan.box.module.iot.dal.mysql.ota.IotOtaUpgradeRecordMapper;
import com.weiwan.box.module.iot.enums.ota.IotOtaUpgradeRecordStatusEnum;
...
public class IotOtaUpgradeRecordServiceImpl implements IotOtaUpgradeRecordService {
     ...
     * @throws com.weiwan.box.framework.common.exception.ServiceException，则抛出异常，异常类型为OTA_UPGRADE_RECORD_NOT_EXISTS。
     */
     ...
     * @throws com.weiwan.box.framework.common.exception.ServiceException，则抛出 OTA_UPGRADE_RECORD_CANNOT_RETRY 异常
     */
