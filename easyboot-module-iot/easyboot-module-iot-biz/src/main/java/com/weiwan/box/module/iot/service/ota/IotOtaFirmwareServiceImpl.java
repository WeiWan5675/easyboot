...
import com.weiwan.box.module.iot.dal.mysql.ota.IotOtaFirmwareMapper;
...
import static com.weiwan.box.module.iot.enums.ErrorCodeConstants.OTA_FIRMWARE_NOT_EXISTS;
import static com.weiwan.box.module.iot.enums.ErrorCodeConstants.OTA_FIRMWARE_PRODUCT_VERSION_DUPLICATE;
...
public class IotOtaFirmwareServiceImpl implements IotOtaFirmwareService {
     ...
     * @throws com.weiwan.box.framework.common.exception.ServiceException，则抛出异常，提示固件信息已存在
     */
