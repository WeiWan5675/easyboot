package com.weiwan.box.module.member.controller.admin.config;

import com.weiwan.box.framework.common.pojo.CommonResult;
import com.weiwan.box.module.member.controller.admin.config.vo.MemberConfigRespVO;
import com.weiwan.box.module.member.controller.admin.config.vo.MemberConfigSaveReqVO;
import com.weiwan.box.module.member.convert.config.MemberConfigConvert;
import com.weiwan.box.module.member.dal.dataobject.config.MemberConfigDO;
import com.weiwan.box.module.member.service.config.MemberConfigService;
